  ...
  return (
    <section className="pt-32 pb-20 px-6">
      <div className="max-w-[1280px] mx-auto text-center">
        ...
        <p className="text-xl text-[#a1a1aa] mb-12 max-w-3xl mx-auto">
          Codebase Wiki parses your repository structure, extracts inline comments, 
          and builds a navigable wiki. No manual maintenance required.
        </p>
